...
urlpatterns = [
    ...
    path('hotel/<int:hotel_id>/add_amenity/', views.add_hotel_amenity, name='add_hotel_amenity'),
    path('hotel/amenity/<int:id>/edit/', views.edit_hotel_amenity, name='edit_hotel_amenity'),
    path('hotel/amenity/<int:id>/delete/', views.delete_hotel_amenity, name='delete_hotel_amenity'),
